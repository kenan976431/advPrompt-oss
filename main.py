...
class Workspace:
    ...
    def eval_suffix_dataset(self, suffix_dataset_key, suffix_dataset_pth):
        ...
        for batch_idx, batch in enumerate(pbar):
            ...
            # --------- check jb for each trial and save successful attacks
            from save_successful_attacks import save_successful_attacks
            ...
            # Save successful attacks   # 新增的。。。。。
            save_dir = os.path.join(self.cfg.output_dir, "successful_attacks")
            save_successful_attacks(
                target_llm_ar=target_llm_ar,
                instruct=instruct,
                full_instruct=full_instruct,
                jailbroken_list=jailbroken_list,
                test_prefixes=self.test_prefixes,
                save_dir=save_dir
            )
